...
@section('content')
    ...
    background-size: cover;">
        ...
        <div class="container ">
            <div class="row" style="box-shadow: 1px 1px 2px 1px gray font-family: 'Gill Sans', sans-serif;">
                <div class="col-md-8 " style="font-family: 'Gill Sans', sans-serif;">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row d-flex justify-content-center space-between" style="margin-left:527px;font-family: 'Gill Sans', sans-serif;">
                ...
                <div class="col-md-4 "style="font-family: 'Gill Sans', sans-serif;">
