...
<div class="modal-footer">
   ...
   <button type="button" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('deletecomment-{{$reply_comment->id}}').submit();">Confirm</button>
   <form action="{{route('admin.comment-Reply.delete',$reply_comment->id)}}" style="display: none" id="deletecomment-{{$reply_comment->id}}" method="POST">
      @csrf
